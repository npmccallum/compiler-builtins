...
## [0.2.17](https://github.com/rust-lang/compiler-builtins/compare/libm-v0.2.16...libm-v0.2.17) - 2026-07-28

### Other

- test Miri on libm
- do not use arch-specific implementations with Miri
- Update the license comment for fma / fma_wide
- Rename `HFloat` and `DFloat` to `NarrowFloat` and `WideFloat`
- add tests for fdim*
- Add LoongArch implementations of fma, rint, and sqrt
